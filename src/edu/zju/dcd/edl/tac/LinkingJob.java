...
//		Document[] documents = QueryReader.toDocumentsXmlFile(queryFile);
...
//			documents = QueryReader.toDocumentsXmlFile(queryFile);
//		else
//			documents = QueryReader.toDocumentsTabFile(queryFile);
//
...
//		Document[] documents = QueryReader.toDocumentsXmlFile(queryFileName);
